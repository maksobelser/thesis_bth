...
def run(addl_dataset_train: str,
    ...
    sampled_genes = genes_intersection['genes_shared_across_datasets'].sample(n=3000, random_state=seed_for_genes).tolist()
    
    ## making random splits
    adata_train = adata_train[:,adata_train.var.index.isin(sampled_genes)]
